...
const index = () => {
	...
	//funcion para extraer todos los signos de FireStore
	...
	//Funcion para extraer los datos de un signo
	...
	//Esta Funcion actualiza el signo seleccionado dentro del componente
	...
	//Hook que comprubea si si somos el administrador si no push a otra ruta.
	useEffect(() => {
	...
	return (
		<div className='mt-5'>
			...
			<FormControl
				...
				as='textarea'
				rows='12'
				placeholder={datasigno != null ? datasigno.descripcion : ""}
			></FormControl>
			<input
				...
				type='date'
			/>
			<Button onClick={actualizarSigno} className='btn btn-info btn-block mt-3'>
				ACTUALIZAR SIGNO
			</Button>
		</div>
	);
